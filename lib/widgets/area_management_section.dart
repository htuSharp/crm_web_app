...
class _AreaManagementSectionState extends State<AreaManagementSection> {
          ...
          children: [
            ...
            TextField(
              ...
              onSubmitted: (value) {
                ...
                if (selectedHQ != null) {
                  widget.onAdd(
                    AreaEntry(area: value, headquarter: selectedHQ!),
                  );
                }
              },
            ),
  ...
  void _showEditAreaDialog(AreaEntry entry) {
    ...
    showDialog(
      context: context,
      builder: (_) => AlertDialog(
        title: const Text('Edit Area', style: DataManagementStyles.titleStyle),
        content: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            DropdownButtonFormField<String>(
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () {
              ...
              if (newAreaName.isNotEmpty && selectedHQ != null) {
  ...
  Widget build(BuildContext context) {
    final filteredList = widget.areas
        .where(
          (entry) =>
